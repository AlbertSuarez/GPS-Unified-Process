...
Un usuari un cop s'ha enregistrat al sistema ja pot utilitzar l'aplicació, però perquè el sistema el reconegui ha d'iniciar sessió prèviament.
...
Un cop dins d'un servei en concret, l'usuari pot contactar amb el propietari del servei via chat dins de la mateixa aplicació i així poder parlar directament amb l’altre usuari de la comunitat.
...
Un cop un usuari ha rebut un servei d'un altre usuari, ha de pagar aquest servei. L'usuari tindrà l'opció de pagar a l'altre usuari les hores marcades en el preu del servei anunciat.
